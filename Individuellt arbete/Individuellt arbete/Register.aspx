...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="RegisterForm" runat="server">
        ...
        <ul>
            ...
            <li>
                <asp:TextBox ID="FirstName" Length="45" runat="server" />
            ...
            <li>
                <asp:TextBox runat="server" Length="45" ID="LastName"/>
            ...
            <li>
                <asp:TextBox runat="server" ID="PrimaryEmail"/>
            ...
            <li>
                <asp:TextBox runat="server" ID="PrimaryEmailVerify"/>
